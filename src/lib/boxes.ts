 ...
 *
 * It lives here rather than with the other constants in `presets.ts` because
 * this is the module where a box becomes a number, and `boxPrices.ts` — which
 * turns the feed's dollars into gems — has to be importable by `presets.ts`
